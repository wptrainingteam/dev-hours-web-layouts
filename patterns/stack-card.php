...
/**
 * Title: Stack Card
 * Slug: dev-hours-web-layouts/stack-card
 * Categories: themeslug-dev-hours
 * Viewport width: 1024
 */
?>
<!-- wp:group {"style":{"border":{"width":"1px"},"dimensions":{"minHeight":""},"spacing":{"blockGap":"4rem"}},"borderColor":"accent","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","verticalAlignment":"space-between"}} -->
<div class="wp-block-group has-border-color has-accent-border-color" style="border-width:1px">
	...
	<div class="wp-block-group">
		...
		<figure class="wp-block-image size-large"><img src="<?= esc_url(get_theme_file_uri('assets/images/mountain-road.jpg')) ?>" alt="" class="wp-image-3576" style="aspect-ratio:16/9;object-fit:cover"/></figure>
		<!-- /wp:image -->
	...
	<div class="wp-block-group has-background" style="background-color:#b5bdbc3d;padding-top:var(--wp--preset--spacing--10);padding-right:2rem;padding-bottom:var(--wp--preset--spacing--10);padding-left:2rem">
		...
		<!-- wp:paragraph -->
		<p>Footer: space between it and other parts of the card.</p>
		<!-- /wp:paragraph -->
