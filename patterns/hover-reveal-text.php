 ...
 * Slug: dev-hours-web-layouts/hover-reveal-text
	...
	<div class="wp-block-columns alignwide">
		...
		<?php foreach(range(1,3) as $column) : ?>
			...
			<div class="wp-block-column">
				...
				<!-- wp:cover {"url":"<?= esc_url(get_theme_file_uri('assets/images/mountain-road.jpg')) ?>","id":5098,"dimRatio":50,"overlayColor":"contrast","isUserOverlayColor":true,"minHeight":50,"style":{"elements":{"link":{"color":{"text":"var:preset|color|base-2"}}}},"textColor":"base-2","className":"is-style-reveal-text","layout":{"type":"constrained"}} -->
				<div class="wp-block-cover is-style-reveal-text has-base-2-color has-text-color has-link-color" style="min-height:50px">
